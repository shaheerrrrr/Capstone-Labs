...
public class SimplePicture implements DigitalPicture
{
 ...
 public boolean load(String fileName)
 {
     try {
         ...
         //System.out.println("There was an error trying to open " + fileName); rg commented out
         bufferedImage = new BufferedImage(700,500,
                                           BufferedImage.TYPE_INT_RGB);
         //addMessage("Couldn't load " + fileName,5,100); //rg commented out
         return false;
     }
