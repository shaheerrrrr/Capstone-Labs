...
//rg added
   private JPanel setUpSideMenu()
   {
      ...
      JButton button_mirrorRL = new JButton("Mirror R/L");
      ...
      JButton button_mirrorBT = new JButton("Mirror B/T");
      ...
      JButton button_mirrorDiagOpp = new JButton("Mirror Diag Opposite");
...
*/
   ...
   */
   ...
   private class Listener_Surprise implements ActionListener {
      public void actionPerformed(ActionEvent e) {
         // Hardcoded file path
         File file = new File("C:\\Users\\1619470\\OneDrive - Fairfax County Public Schools\\Documents\\CS Stuff\\Capstone Labs\\FauxtoShop_LAB\\FauxtoShop_STUDENT\\classes\\squirrel.jpg");
         if (file.exists()) {
            System.out.println("You chose to open this file: " + file);
            Picture squirrel = new Picture(file.getAbsolutePath());
            ((Picture) picture).squirrel(squirrel);
         } else {
