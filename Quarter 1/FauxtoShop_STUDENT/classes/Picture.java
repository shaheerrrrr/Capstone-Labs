...
////////////////////// methods ///////////////////////////////////////
    ...
    public void squirrel(Picture squirrel)
    {
        Pixel[][] pixels = this.getPixels2D();
        Pixel[][] surprisePixels = squirrel.getPixels2D();
        for (int r = surprisePixels.length-1; r >= 0; r--)
        {
            for (int c = 0; c < surprisePixels[0].length; c++)
            {
                Pixel pixelObj = pixels[r][c];
                Pixel surprisePixel = surprisePixels[r][c];
                if(surprisePixel.colorDistance(Color.WHITE) > 64){
                    pixelObj.setColor(surprisePixel.getColor());
                }
